...
$routes->group('admin', function ($routes) {
    ...
    $routes->resource('subcategorias', [
        'filter' => 'permission:subcategorias-permission',
        'controller' => 'subcategoriasController',
        'namespace' => 'julio101290\boilerplateproducts\Controllers',
        'except' => 'show'
    ]);

    $routes->post('subcategorias/save'
            , 'SubcategoriasController::save'
            , ['namespace' => 'julio101290\boilerplateproducts\Controllers']
    );

    $routes->post('subcategorias/getSubcategorias'
            , 'SubcategoriasController::getSubcategorias'
            , ['namespace' => 'julio101290\boilerplateproducts\Controllers']
    );

    $routes->post('subCategorias/getSubCategoriasAjax'
